...
Reset_Handler:
    ...
    // Регистр с 0 для операций сравнения
    mov    r11,   #0
...
// Расчет параметров ШИМ сигнала
	// Проверка, что текущее знаечние Ton меньше максимального, иначе смена направления
    cmp    r3,    r7                                  // if (TimeOnMaxInCycle < r7) {r6 = 1;}
    it     LO
    movlo  r6,    #1

	// Проверка, что текущее знаечние Ton больше минимального, иначе смена направления
    cmp    r4,    r7                                  // if (TimeOnMinInCycle > r7) {r6 = 0;}
    it     GT
    movgt  r6,    #0

	// В зависимости от флага увеличиваем или уменьшаем текущее значение Ton
    cmp    r11,   r6                                  // r11 = 0, r6 - флаг
    it     EQ
    addeq  r7,    r7,    #StepServo                   // Ton++;
    it     NE
    subne  r7,    r7,    #StepServo                   // Ton--;

	// Расчет Toff = Period - Ton
    sub    r8,    r5,    r7
